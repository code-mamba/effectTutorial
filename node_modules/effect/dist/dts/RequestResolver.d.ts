 ...
 * @category constructors
 */
export declare const makeBatched: <A extends Request.Request<any, any>, R>(run: (requests: Array<A>) => Effect.Effect<void, never, R>) => RequestResolver<A, R>;
/**
...
export declare const aroundRequests: {
    <A, A2, R2, X, R3>(before: (requests: ReadonlyArray<NoInfer<A>>) => Effect.Effect<A2, never, R2>, after: (requests: ReadonlyArray<NoInfer<A>>, _: A2) => Effect.Effect<X, never, R3>): <R>(self: RequestResolver<A, R>) => RequestResolver<A, R2 | R3 | R>;
    <A, R, A2, R2, X, R3>(self: RequestResolver<A, R>, before: (requests: ReadonlyArray<NoInfer<A>>) => Effect.Effect<A2, never, R2>, after: (requests: ReadonlyArray<NoInfer<A>>, _: A2) => Effect.Effect<X, never, R3>): RequestResolver<A, R | R2 | R3>;
};
/**
 ...
 * @category constructors
 */
export declare const fromFunctionBatched: <A extends Request.Request<any>>(f: (chunk: Array<A>) => Iterable<Request.Request.Success<A>>) => RequestResolver<A>;
/**
