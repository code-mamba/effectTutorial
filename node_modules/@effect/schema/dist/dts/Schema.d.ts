...
export declare function filter<A>(predicate: Predicate.Predicate<NoInfer<A>>, annotations?: Annotations.Filter<NoInfer<A>>): <I, R>(self: Schema<A, I, R>) => Schema<A, I, R>;
/**
 * @category api interface
 * @since 1.0.0
 */
...
export declare const attachPropertySignature: {
    <K extends PropertyKey, V extends AST.LiteralValue | symbol, A extends object>(key: K, value: V, annotations?: Annotations.Schema<Types.Simplify<A & {
        readonly [k in K]: V;
